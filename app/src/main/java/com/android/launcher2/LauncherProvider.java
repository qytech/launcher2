    ...
    synchronized public void loadDefaultFavoritesIfNecessary(int origWorkspaceResId,
        ...
        if (dbCreatedNoWorkspace || overridePrevious) {
            ...
            if (workspaceResId == 0) {
                ...
                Log.d("LauncherProvider", "loadDefaultFavoritesIfNecessary: default_workspace");
            } else {
                Log.d("LauncherProvider", "loadDefaultFavoritesIfNecessary: default_workspace not load");
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version < 9) {
                ...
                Log.d("LauncherProvider", "onUpgrade: update_workspace");
                version = 9;
            }
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        added = id >= 0;
                        Log.d("LauncherProvider", "loadFavorites: " + added);
